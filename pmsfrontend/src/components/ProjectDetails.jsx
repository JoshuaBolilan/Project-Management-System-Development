...
const ProjectDetails = () => {
    ...
    return (
        <div className="project-details-container">
            ...
            <p><strong>Total Budget:</strong> 2000,000{project.budget}</p>
            <p><strong>Actual Cost:</strong> 400,000{project.actual_cost}</p>
            <p><strong>Remaining Budget:</strong> 600,000{project.budget - project.actual_cost}</p>
