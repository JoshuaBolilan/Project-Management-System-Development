...
const ExpenditureList = () => {
  ...
  if (checkingOwner || loading) {
    return (
      <div className="text-center mt-5" style={{ marginLeft: '200px' }}>
  ...
  if (error) {
    return (
      <div className="alert alert-danger" style={{ marginLeft: '200px' }}>
        {error}
      </div>
    );
  }
  ...
  return (
    <div className="mt-4" style={{ marginLeft: '200px', padding: '20px' }}>
